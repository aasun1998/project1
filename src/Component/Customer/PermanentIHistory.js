...
export default function PermanentIhistory() {

    const[historyDetails, setHistoryDetails]=useState([])

    useEffect(() => {
        instance.get("/permanent/insurance/history/view", {
    ...
    //     await axios.post(`http://localhost:5000/history/insurance/${value._id}`,{
    ...
    return (
       ...
       <div className="main-content-wrap sidenav-open d-flex flex-column">
           <h2>Permanent Insurance History</h2>
...
{/* <td><svg onClick={(e)=>handelSend(value, e)} width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-bar-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
